...
# Site web du CSEP
The dépot décrit le contenu du [site web du CSEP](https://cse.binets.fr).
Il utilise Hugo pour générer le site web à partie de fichier textes Markdown et CSS, des images, etc.
